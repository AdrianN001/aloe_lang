...
use crate::{ast::expression::Expression, object::{Object, ObjectRef}};
...
impl Object{
    pub fn apply_attribute(&self, name: &str) -> ObjectRef{
        match self{
            ...
            _ => Rc::new(RefCell::new(Object::new_error("type has no attribute".into())))
        }
    }
    ...
    pub fn apply_method(&mut self, name: &str, args: &[ObjectRef]) -> ObjectRef{
        match self{
            ...
            _ => Rc::new(RefCell::new(Object::new_error("type has no methods".into())))
        }
    }
}

...
use crate::{module::{Module, ModuleRef, module_error::ModuleError, module_loader::ModuleLoader}, version::CURRENT_VERSION};
...
pub fn get_std_lib_location(module_path: &str, version_str: &str) -> Result<String, ModuleError> {
    let home_dir = match env::home_dir(){
        None => return Err(ModuleError::new(module_path, "could not get your home directory (~)")),

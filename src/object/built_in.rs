...
use crate::object::{
    ObjectRef, built_in::{
        ...
        }, console::{console_read_builtin_function, console_write_builtin_function}, error::error_builtin_function, iterator::range_builtin_function, len::len_builtin_function, random::random_builtin_function, utils::{inspect_builtin_function, type_builtin_function}
    }, panic_obj::PanicObj, stack_environment::EnvRef, state::StateRef
};
...
impl BuiltIn {
    ...
    pub fn call(&self, args: &[ObjectRef], environ: EnvRef, state: StateRef) -> Result<ObjectRef, PanicObj> {
        match self {
